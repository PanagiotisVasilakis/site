...
Use the active Node 22.19/npm 11.18 runtime. The repository intentionally has no automated test suite or GitHub Actions workflows. Retained validation is invoked manually:
