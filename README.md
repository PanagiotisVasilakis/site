...
The guest portal uses a direct verification flow without OTP or CAPTCHA challenges. The unified page at `/{locale}/guest` supports Sign‑in and Sign‑up modes with:
...
No OTP/CAPTCHA flags or strings are present in the codebase; i18n dictionaries have been pruned accordingly.
