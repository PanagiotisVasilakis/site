...
describe('public API surface remains reachable', () => {
  ...
  it('ensures exported types remain available', () => {
    ...
    expectTypeOf<Booking>().toMatchTypeOf<Record<string, unknown>>();
    ...
    expectTypeOf<BookingLookupProvider>().toMatchTypeOf<Record<string, unknown>>();
    ...
    expectTypeOf<BookingStatus>().toMatchTypeOf<'active' | 'checked_out' | 'cancelled'>();
    expectTypeOf<PerformanceBudget>().toMatchTypeOf<Record<string, unknown>>();
    expectTypeOf<Origin>().toMatchTypeOf<string>();
    expectTypeOf<SecurityConfig>().toMatchTypeOf<Record<string, unknown>>();
  ...
  expectTypeOf<ApiRouteHandler>().toMatchTypeOf<(...args: any[]) => any>();
    ...
    expectTypeOf<AppConfig>().toMatchTypeOf<Record<string, unknown>>();
    expectTypeOf<AvailabilityInfo>().toMatchTypeOf<Record<string, unknown>>();
    expectTypeOf<IndexDictionary>().toMatchTypeOf<Record<string, unknown>>();
    ...
    expectTypeOf<EventProps>().toMatchTypeOf<Record<string, unknown>>();
    expectTypeOf<LeafletMapProps>().toMatchTypeOf<Record<string, unknown>>();
    expectTypeOf<LazyMapMarkerData>().toMatchTypeOf<{ id: string }>();
    expectTypeOf<TravelMode>().toMatchTypeOf<'driving' | 'foot' | 'cycling'>();
    expectTypeOf<AnalyticsPersistenceData>().toMatchTypeOf<Record<string, unknown>>();
    expectTypeOf<AnalyticsStorageAdapter>().toMatchTypeOf<Record<string, unknown>>();
  });
});
