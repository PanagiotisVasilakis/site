    ...
    <div className="relative overflow-hidden min-h-svh bg-transparent">
      ...
      <div className="relative z-10 flex items-center justify-center min-h-svh bg-transparent px-6 sm:px-10 py-12">
        <div className="relative text-center max-w-4xl mx-auto">
          {/* Elegant diffuse fade to improve text readability - Light mode only as per request */}
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[120%] h-[120%] -z-10 rounded-full bg-white/40 blur-[80px] pointer-events-none" aria-hidden />
