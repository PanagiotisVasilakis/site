...
export default function LocaleSwitcher() {
  return (
    <Suspense fallback={
  <div className="inline-flex items-center justify-center px-3 py-1 rounded-full text-[11px] font-semibold tracking-wide bg-black/10 text-slate-800 dark:bg-zinc-800/60 dark:!text-white">
        --
      </div>
    }>
